...
export function ProductDetailView({ 
    ...
    const dictionary = {
        ...
        pt: {
            ...
            engineeringDesc: `Explore os componentes industriais de alta precisão que tornam a ${name} uma ferramenta superior.`,
        ...
        it: {
            ...
            supportDesc: "Uno specialista tecnico ti consiglierà sul modello che meglio si adatta al tuo volume di produzione.",
