...
export function WarrantyPopup() {
    ...
    const d = {
        es: {
            ...
            disclaimerSuffix: "). Modelos Alaska, Andra, Tobago, Miranda y Estambul: 1 año.",
            cta: "Activar ahora",
        ...
        en: {
            ...
            disclaimerSuffix: "). Alaska, Andra, Tobago, Miranda and Estambul: 1 year.",
            cta: "Activate now",
        ...
        pt: {
            ...
            disclaimerSuffix: "). Modelos Alaska, Andra, Tobago, Miranda e Estambul: 1 ano.",
            cta: "Ativar agora",
        ...
        it: {
            ...
            disclaimerSuffix: "). Modelli Alaska, Andra, Tobago, Miranda e Estambul: 1 anno.",
            cta: "Attiva ora",
