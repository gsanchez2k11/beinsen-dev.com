...
export function WarrantyPopup() {
    ...
    const d = {
        es: {
            ...
            disclaimerSuffix: "). Modelos Andra, Tobago, Miranda y Felina: 1 año.",
            cta: "Activar ahora",
        ...
        en: {
            ...
            disclaimerSuffix: "). Andra, Tobago, Miranda and Felina: 1 year.",
            cta: "Activate now",
        ...
        pt: {
            ...
            disclaimerSuffix: "). Modelos Andra, Tobago, Miranda e Felina: 1 ano.",
            cta: "Ativar agora",
        ...
        it: {
            ...
            disclaimerSuffix: "). Modelli Andra, Tobago, Miranda e Felina: 1 anno.",
            cta: "Attiva ora",
