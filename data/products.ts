...
export const allAccessoriesData: Accessory[] = [
  ...
  },
  {
    ...
    "price": "Consultar PVP",
    "image": "https://tiendasublimacion.com/media/catalog/product/cache/b1fc9389cb3c8abc49296622cc18a994/3/d/3d-10.webp",
    "description": {
      "es": "Molde de placa de polímero de sublimación que se utiliza en una prensa térmica al vacío 3D para evitar que las placas de polímero se deformen durante el proceso de sublimación. El molde está dividido en varios círculos de diferentes tamaños, lo que le permite ajustar el molde para adaptarse a platos de distintos tamaños, garantizando resultados uniformes y de alta calidad.",
      "en": "Sublimation polymer plate mold used in a 3D vacuum heat press to prevent polymer plates from deforming during the sublimation process. The mold is divided into several circles of different sizes, allowing you to adjust the mold to fit plates of different sizes, ensuring uniform and high quality results.",
      "pt": "Molde de placa de polímero de sublimação usado em uma prensa térmica a vácuo 3D para evitar que as placas de polímero se deformem durante o processo de sublimação. O molde é dividido em vários círculos de diferentes tamanhos, permitindo que você ajuste o molde para se adequar a pratos de diferentes tamanhos, garantindo resultados uniformes e de alta qualidade.",
      "it": "Stampo piastra polimero sublimazione utilizzato in una pressa termica a vuoto 3D per evitare che le piastre in polimero si deformino durante il processo di sublimazione. Lo stampo è diviso in più cerchi di diverse dimensioni, consentendoti di regolare lo stampo per adattarsi a piatti di diverse dimensioni, garantendo risultati uniformi e di alta qualità."
    },
    "technicalSpecs": [
      { "label": { "es": "Compatibilidad", "en": "Compatibility", "pt": "Compatibilidade", "it": "Compatibilità" }, "value": "Platos de 6 a 10\" (15 cm - 25 cm)" },
      { "label": { "es": "Diámetros internos del molde", "en": "Internal mold diameters", "pt": "Diâmetros internos do molde", "it": "Diametri interni dello stampo" }, "value": "13,5 cm, 15,5 cm, 17 cm, 20 cm" },
      { "label": { "es": "Material", "en": "Material", "pt": "Material", "it": "Materiale" }, "value": "Polímero de sublimación / Sublimation polymer" },
      { "label": { "es": "Diseño", "en": "Design", "pt": "Design", "it": "Design" }, "value": "Círculos múltiples para adaptarse a diferentes tamaños de platos" },
      { "label": { "es": "Función", "en": "Function", "pt": "Função", "it": "Funzione" }, "value": "Evita deformación de placas durante la sublimación y garantiza resultados uniformes" },
      { "label": { "es": "Aplicación", "en": "Application", "pt": "Aplicação", "it": "Applicazione" }, "value": "Prensa térmica al vacío 3D / 3D vacuum heat press" },
