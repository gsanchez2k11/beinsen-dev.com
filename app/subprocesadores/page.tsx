        ...
        en: (
            <>
                        ...
                        <table className="w-full text-sm border border-border rounded-2xl overflow-hidden">
                            ...
                            <tbody className="divide-y divide-border">
                                ...
                                <tr>
                                    ...
                                    <td className="p-4 text-muted-foreground">Delivery of the emails generated by the contact and booking forms to the corporate mailbox info@beinsen.com / web@futura.es.</td>
                                    <td className="p-4 text-muted-foreground">Configurable. Full details available on request from <a href="mailto:privacidad@beinsen.com" className="text-[#FF6600] hover:underline">privacidad@beinsen.com</a>.</td>
                ...
                <section className="mb-12 space-y-4">
                    ...
                    <p className="text-muted-foreground text-sm leading-relaxed">
                        If you have reasonable objections regarding a new subprocessor, you may raise them within 30 days at <a href="mailto:privacidad@beinsen.com" className="text-[#FF6600] hover:underline">privacidad@beinsen.com</a>. If the objection cannot be resolved, you may terminate your relationship with Futura Teck with respect to the affected processing activities.
                    </p>
                </section>
                ...
                <section className="mb-12 space-y-4">
                    ...
                    <p className="text-muted-foreground text-sm leading-relaxed">
                        The Data Processing Agreements (DPA) signed with each subprocessor, as well as the safeguards covering international transfers (SCC and/or adherence to adequacy frameworks), are available to customers with a contractual relationship or to entities required to audit the chain of subprocessing (for example, procurement departments of large accounts). Request them in writing from <a href="mailto:privacidad@beinsen.com" className="text-[#FF6600] hover:underline">privacidad@beinsen.com</a>.
                    </p>
                </section>
        ...
        pt: (
            <>
                        ...
                        <table className="w-full text-sm border border-border rounded-2xl overflow-hidden">
                            ...
                            <tbody className="divide-y divide-border">
                                ...
                                <tr>
                                    ...
                                    <td className="p-4 text-muted-foreground">Envio dos emails gerados pelos formulários de contacto e reserva para a caixa de correio corporativa info@beinsen.com / web@futura.es.</td>
                                    <td className="p-4 text-muted-foreground">Configurável. Solicite os dados completos a <a href="mailto:privacidad@beinsen.com" className="text-[#FF6600] hover:underline">privacidad@beinsen.com</a>.</td>
                ...
                <section className="mb-12 space-y-4">
                    ...
                    <p className="text-muted-foreground text-sm leading-relaxed">
                        Caso tenha objeções fundamentadas relativamente a um novo subprocessador, poderá apresentá-las no prazo de 30 dias para <a href="mailto:privacidad@beinsen.com" className="text-[#FF6600] hover:underline">privacidad@beinsen.com</a>. Se a objeção não puder ser resolvida, poderá cessar a relação com a Futura Teck no que respeita aos tratamentos afetados.
                    </p>
                </section>
        ...
        it: (
            <>
                        ...
                        <table className="w-full text-sm border border-border rounded-2xl overflow-hidden">
                            ...
                            <tbody className="divide-y divide-border">
                                ...
                                <tr>
                                    ...
                                    <td className="p-4 text-muted-foreground">Invio delle email generate dai moduli di contatto e di prenotazione alla casella di posta aziendale info@beinsen.com / web@futura.es.</td>
                                    <td className="p-4 text-muted-foreground">Configurabile. Dati completi disponibili su richiesta scritta a <a href="mailto:privacidad@beinsen.com" className="text-[#FF6600] hover:underline">privacidad@beinsen.com</a>.</td>
                ...
                <section className="mb-12 space-y-4">
                    ...
                    <p className="text-muted-foreground text-sm leading-relaxed">
                        In presenza di obiezioni ragionevoli su un nuovo subprocessore, è possibile sollevarle entro 30 giorni scrivendo a <a href="mailto:privacidad@beinsen.com" className="text-[#FF6600] hover:underline">privacidad@beinsen.com</a>. Qualora l'obiezione non possa essere risolta, sarà possibile recedere dal rapporto con Futura Teck limitatamente ai trattamenti interessati.
                    </p>
                </section>
