...
export default function AsesorPage() {
    ...
    const d = {
        ...
        pt: {
            tag: "Consultor Beinsen",
            title: "Que prensa térmica precisa?",
            subtitle: "Três perguntas rápidas. Recomendamos o modelo ideal para a sua oficina.",
            q1: "O que vai personalizar principalmente?",
            q2: "Que volume de produção espera?",
            q3: "Que espaço e formato precisa?",
            next: "Seguinte",
            back: "Voltar",
            restart: "Começar de novo",
            results: "Recomendação para si",
            resultsSubtitle: "Cruzámos as suas respostas com o catálogo. Comece por:",
            noResults: "Não encontrámos uma correspondência exata",
            noResultsText: "Tente flexibilizar algum critério ou contacte um especialista.",
            contactSpecialist: "Falar com um especialista",
            whyMatch: "Porque encaixa",
            cat: {
                textil: "Vestuário e têxtil",
                tazas: "Canecas e garrafas",
                gorras: "Bonés",
                especializadas: "Sapatos, bolas, caneleiras…",
                multifuncion: "Multifunção (vários formatos)",
                cualquiera: "Vários / não tenho a certeza",
            },
            vol: {
                bajo: "Baixo (<20 peças/dia)",
                medio: "Médio (20–100 peças/dia)",
                alto: "Alto (+100 peças/dia)",
            },
            volDesc: {
                bajo: "Hobby, encomendas esporádicas, pequena oficina",
                medio: "Oficina profissional com procura constante",
                alto: "Produção industrial, séries longas",
            },
            fmt: {
                compacta: "Compacto",
                estandar: "Standard profissional",
                industrial: "Industrial / grande formato",
            },
            fmtDesc: {
                compacta: "Oficina em casa, pouco espaço",
                estandar: "Oficina profissional média",
                industrial: "Pavilhão, alta produtividade",
            },
        },
        it: {
            tag: "Consulente Beinsen",
            title: "Quale pressa termica ti serve?",
            subtitle: "Tre domande rapide. Ti consigliamo il modello ideale per la tua officina.",
            q1: "Cosa personalizzerai principalmente?",
            q2: "Che volume di produzione prevedi?",
            q3: "Che spazio e formato ti servono?",
            next: "Avanti",
            back: "Indietro",
            restart: "Ricomincia",
            results: "Il nostro consiglio",
            resultsSubtitle: "Abbiamo incrociato le tue risposte con il catalogo. Inizia da:",
            noResults: "Nessuna corrispondenza esatta",
            noResultsText: "Prova ad allentare un criterio o parla con uno specialista.",
            contactSpecialist: "Parla con uno specialista",
            whyMatch: "Perché si adatta",
            cat: {
                textil: "Abbigliamento e tessile",
                tazas: "Tazze e bottiglie",
                gorras: "Cappellini",
                especializadas: "Scarpe, palloni, parastinchi…",
                multifuncion: "Multifunzione (vari formati)",
                cualquiera: "Vari / non ne sono sicuro",
            },
            vol: {
                bajo: "Basso (<20 pezzi/giorno)",
                medio: "Medio (20–100 pezzi/giorno)",
                alto: "Alto (+100 pezzi/giorno)",
            },
            volDesc: {
                bajo: "Hobby, ordini sporadici, piccolo laboratorio",
                medio: "Laboratorio professionale a domanda costante",
                alto: "Produzione industriale, serie lunghe",
            },
            fmt: {
                compacta: "Compatto",
                estandar: "Standard professionale",
                industrial: "Industriale / grande formato",
            },
            fmtDesc: {
                compacta: "Laboratorio in casa, poco spazio",
                estandar: "Laboratorio professionale medio",
                industrial: "Capannone, alta produttività",
            },
        }
    }[locale] || { es: {} }.es;
