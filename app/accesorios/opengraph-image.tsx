...
export const alt = 'Accesorios Originales Beinsen para Planchas Transfer'
...
export default async function Image() {
    return new ImageResponse(
        (
            ...
            >
                <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: 'radial-gradient(circle at 60% 40%, rgba(255,102,0,0.15) 0%, transparent 55%)' }} />
                ...
                <div style={{ fontSize: '68px', fontWeight: 900, color: '#ffffff', lineHeight: 1, marginBottom: '20px', fontStyle: 'italic' }}>
                    ...
                    <br />
                    <span style={{ color: '#FF6600' }}>Certificados</span>
                </div>
                <div style={{ fontSize: '22px', color: 'rgba(255,255,255,0.55)', fontWeight: 300, marginBottom: '40px', maxWidth: '700px' }}>
                    Compatibilidad garantizada · Uso industrial · Componentes originales
                </div>
