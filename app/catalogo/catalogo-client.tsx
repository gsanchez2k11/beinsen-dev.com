...
function CatalogoHeader() {
    ...
    const d = ({
        ...
        pt: {
            tag: "Tecnologia de Transferência",
            highlight: "Beinsen",
            title: "Catálogo",
            subtitle: "Explore a nossa gama de soluções industriais para sublimação e transfer têxtil.",
        },
        it: {
            tag: "Tecnologia di Trasferimento",
            highlight: "Beinsen",
            title: "Catalogo",
            subtitle: "Esplora la nostra gamma di soluzioni industriali per sublimazione e transfer tessile.",
        },
    } as Record<string, { tag: string; highlight: string; title: string; subtitle: string }>)[locale] || {
        tag: "Tecnología de Transferencia",
        highlight: "Beinsen",
        title: "Catálogo",
        subtitle: "Explora nuestra gama de soluciones industriales para sublimación y transfer textil.",
...
function CatalogoContent() {
    ...
    const d = {
        ...
        pt: {
            ...
            tag: "Tecnologia de Transferência",
            subtitle: "Explore a nossa gama de soluções industriais para sublimação e transfer têxtil.",
            searchPlaceholder: "Modelo, categoria ou componente...",
            filters: "Filtros",
            catLabel: "Especialidade",
            openLabel: "Sistema",
            formatLabel: "Formato",
            plateLabel: "Tabuleiro",
            clear: "Limpar",
            results: "itens",
            showing: "A mostrar",
            noResults: "Sem correspondências",
            noResultsText: "Tente ajustar os filtros ou procurar por um termo mais simples.",
            clearBtn: "Repor filtros",
            all: "Todo o catálogo",
            machines: "Máquinas",
            accessories: "Acessórios",
            consumables: "Consumíveis",
            filterTitle: "Pesquisa Avançada",
            loadMore: "Ver mais",
            compatibleWith: "Máquina compatível",
        ...
        it: {
            ...
            tag: "Tecnologia di Trasferimento",
            subtitle: "Esplora la nostra gamma di soluzioni industriali per sublimazione e transfer tessile.",
            searchPlaceholder: "Modello, categoria o componente...",
            filters: "Filtri",
            catLabel: "Specialità",
            openLabel: "Sistema",
            formatLabel: "Formato",
            ...
            noResultsText: "Prova a regolare i filtri o cerca un termine più semplice.",
            clearBtn: "Reimposta filtri",
            all: "Tutto il catalogo",
            machines: "Macchine",
            accessories: "Accessori",
            consumables: "Consumabili",
            filterTitle: "Ricerca Avanzata",
            loadMore: "Carica altro",
            compatibleWith: "Macchina compatibile",
        ...
        <div className="bg-background pb-32 selection:bg-[#FF6600] selection:text-white">
            ...
            <main className="max-w-7xl mx-auto px-4 mt-16">
                <div className="flex items-center justify-between mb-12">
                    <h2 className="text-sm font-black uppercase tracking-[0.4em] text-muted-foreground flex items-center gap-4">
