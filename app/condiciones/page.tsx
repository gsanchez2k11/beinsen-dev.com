      ...
      <>
        ...
        <section className="mb-12 space-y-6">
          ...
          <div className="bg-[#FF6600]/5 border-l-4 border-[#FF6600] p-6 rounded-r-2xl space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              La maggior parte dei modelli Beinsen dispone di garanzia di <span className="font-bold text-foreground">3 anni</span>. I modelli <span className="font-semibold text-foreground">Alaska, Andra, Tobago, Miranda e Estambul</span> dispongono di garanzia di <span className="font-bold text-foreground">1 anno</span>. L'attivazione della copertura estesa richiede la registrazione del dispositivo su <a href="https://soporte.beinsen.com" target="_blank" rel="noopener noreferrer" className="text-[#FF6600] hover:underline">soporte.beinsen.com</a> entro 90 giorni dall'acquisto.
            </p>
          </div>
          <p className="text-muted-foreground text-sm leading-relaxed">
