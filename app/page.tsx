...
import { ArrowRight, CheckCircle2, Shield, Zap, Target, MousePointer2, Settings, Box, Package, PlayCircle, Globe2, Users2, Building2, Trophy } from "lucide-react";
...
export default function Home() {
    ...
    return (
        <div className="flex flex-col w-full bg-background" ref={containerRef}>
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden border-b border-border/40">
                ...
                >
                    ...
                    {/* Floating Background Element (Trinidad Teaser) */}
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl opacity-[0.08] pointer-events-none">
                        <Image 
                            src="https://images.unsplash.com/photo-1590249257692-a162df94afff?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"
                            alt="Beinsen Machine Background"
                            width={1200}
                            height={800}
                    ...
                    >
                        ...
                        >
                            <span className="relative z-10 flex items-center gap-2">
                                {d.hero.cta_main} <ArrowRight size={18} />
                            </span>
                        ...
                        >
                            <PlayCircle size={18} className="text-[#FF6600]" /> {d.hero.cta_sec}
                        </Link>
                    </motion.div>
                </div>
                            ...
                            {[
                                ...
                                <ScrollReveal key={i} delay={i * 0.1}>
                                    <div className="flex gap-8 group">
                                        ...
                                        <div>
                                            <h4 className="text-2xl font-black mb-4 group-hover:text-[#FF6600] transition-colors">
                                                {item.title}
                                            </h4>
                                ...
                                <div className="group relative rounded-[2.5rem] overflow-hidden bg-card border border-border/40 hover:border-[#FF6600]/30 transition-all duration-500 h-[500px]">
                                    ...
                                    <div className="absolute inset-0 p-10 flex flex-col justify-end">
                                        <div className="space-y-4">
                                            ...
                                            <Link 
                                                href={`/casos-exito`}
                                                className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-white/40 hover:text-[#FF6600] transition-colors pt-6"
                                            >
