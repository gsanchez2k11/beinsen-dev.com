...
function ContactContent() {
    ...
    const d = {
        ...
        pt: {
            title: "Contacto Técnico",
            subtitle: "Vamos falar de engenharia. A nossa equipa de especialistas está pronta para o aconselhar sobre a melhor solução para a sua produção.",
            modeMessage: "Enviar Mensagem",
            modeAppointment: "Marcar Reunião",
            formTitle: "Pedir Orçamento",
            name: "Nome Completo",
            email: "Correio Eletrónico",
            company: "Empresa",
            country: "País",
            machine: "Máquina de Interesse",
            general: "Consultoria Geral",
            interestSelection: "Tipo de Consulta",
            message: "Como podemos ajudá-lo?",
            send: "Enviar Pedido",
            sending: "A enviar...",
            thanks: "Obrigado pelo seu contacto!",
            thanksDesc: "O seu pedido foi recebido. Um consultor técnico entrará em contacto consigo em menos de 24 horas úteis.",
            step1: "Informação Básica",
            step2: "Detalhes do Projeto",
            next: "Próximo Passo",
            back: "Voltar",
            errorRequired: "Por favor, preencha todos os campos obrigatórios.",
            infoTitle: "Sede Central",
            infoAddress: "Av. Alto de las Atalayas, 18",
            infoCity: "30110 Cabezo de Torres, Múrcia, Espanha",
            infoPhone: "+34 968 902 300",
            infoEmail: "info@beinsen.com",
        ...
        it: {
            ...
            subtitle: "Parliamo di ingegneria. Il nostro team di esperti è pronto a consigliarvi la migliore soluzione per la vostra produzione.",
            modeMessage: "Invia Messaggio",
            modeAppointment: "Prenota Appuntamento",
            formTitle: "Richiedi Preventivo",
            name: "Nome Completo",
            email: "Indirizzo Email",
            company: "Azienda",
            country: "Paese",
            machine: "Macchina di Interesse",
            general: "Consulenza Generale",
            interestSelection: "Tipo di Richiesta",
            message: "Come possiamo aiutarvi?",
            send: "Invia Richiesta",
            sending: "Invio in corso...",
            thanks: "Grazie per averci contattato!",
            thanksDesc: "La vostra richiesta è stata ricevuta. Un consulente tecnico vi contatterà entro 24 ore lavorative.",
            step1: "Informazioni di Base",
            step2: "Dettagli del Progetto",
            next: "Passo Successivo",
            back: "Indietro",
            errorRequired: "Si prega di compilare tutti i campi obbligatori.",
            infoTitle: "Sede Centrale",
            infoAddress: "Av. Alto de las Atalayas, 18",
            infoCity: "30110 Cabezo de Torres, Murcia, Spagna",
            infoPhone: "+34 968 902 300",
            infoEmail: "info@beinsen.com",
